...
/// target-language keyword (e.g. `default`, reserved in Dart). Unlike field
/// names, this is a *declaration* identifier position — `class default {
...
void main() {
  test("keyword input name is sanitized", () {
    ...
    expect(out, contains("static default_ fromJson"));
  });
  ...
  test("keyword interface name is sanitized, including the implements clause", () {
    ...
    expect(ifaceOut, contains("abstract class default_ {"));
    expect(ifaceOut, isNot(contains("abstract class default {")));
