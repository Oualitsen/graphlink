...
data class CounterTickResponse(
    val counterTick: Int,
) {
   fun toJson(): Map<String, Any?> = mapOf(
           "counterTick" to counterTick,
       )

   companion object {
      fun fromJson(map: Map<String, Any?>): CounterTickResponse = CounterTickResponse(
          counterTick = (map["counterTick"] as Number).toInt(),
      )
   }
}
