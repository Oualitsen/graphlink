...
data class CounterTickFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: CounterTickResponse? = null,
   ...
   companion object {
      fun fromJson(map: Map<String, Any?>): CounterTickFullResponse = CounterTickFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { CounterTickResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
