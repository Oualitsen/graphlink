...
class GlExpandTest {
    ...
    class Layer1Vehicle {
        ...
        void vehicleDriver_hasCorrectId() {
            VehicleDriver vd = client.queries.getVehicleDriver("vd-1").getGetVehicleDriver();
        ...
        void vehicle_isCarForVd1() {
            Vehicle vehicle = client.queries.getVehicleDriver("vd-1").getGetVehicleDriver().getVehicle();
        ...
        void vehicle_isBikeForVd2() {
            Vehicle vehicle = client.queries.getVehicleDriver("vd-2").getGetVehicleDriver().getVehicle();
    ...
    class Layer2Owner {
        ...
        void car_owner_hasCorrectId() {
            VehicleOwner owner = client.queries.getVehicleDriver("vd-1").getGetVehicleDriver().getVehicle().getOwner();
        ...
        void bike_owner_hasCorrectId() {
            VehicleOwner owner = client.queries.getVehicleDriver("vd-2").getGetVehicleDriver().getVehicle().getOwner();
    ...
    class Layer4Truncated {
        ...
        void owner_driver_vehicle_isNull_forCar() {
            VehicleDriver inner = client.queries.getVehicleDriver("vd-1")
        ...
        void owner_driver_vehicle_isNull_forBike() {
            VehicleDriver inner = client.queries.getVehicleDriver("vd-2")
                    .getGetVehicleDriver().getVehicle().getOwner().getDriver();
            assertNull(inner.getVehicle());
        }
    }
