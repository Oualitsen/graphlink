...
class DefaultValuesTest {
    ...
    class ListUsersWithDefaults {
        ...
        void returnsUsers_withoutArguments() {
            ListUsersWithDefaultsResponse res = client.queries.listUsersWithDefaults(null, null);
        ...
        void explicitLimit_overridesDefault() {
            ListUsersWithDefaultsResponse res = client.queries.listUsersWithDefaults(1, null);
            assertEquals(1, res.getListUsersWithDefaults().size());
        }

        @Test
        void explicitRole_canBeProvided() {
            ListUsersWithDefaultsResponse res = client.queries.listUsersWithDefaults(null, Role.ADMIN);
            assertFalse(res.getListUsersWithDefaults().isEmpty());
        }
    }
    ...
    class CreateWithDefaults {
        ...
        void role_defaultsToUSER() {
            ...
            CreateWithDefaultsResponse res = client.mutations.createWithDefaults(input);
    ...
    class CreateWithNestedDefaults {
        ...
        void name_isEchoed() {
            ...
            CreateWithNestedDefaultsResponse res = client.mutations.createWithNestedDefaults(input);
