...
data class ResetAllFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: ResetAllResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "ResetAllFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): ResetAllFullResponse = ResetAllFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { ResetAllResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
