...
data class CreateCachedUserFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: CreateCachedUserResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "CreateCachedUserFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): CreateCachedUserFullResponse = CreateCachedUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { CreateCachedUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
