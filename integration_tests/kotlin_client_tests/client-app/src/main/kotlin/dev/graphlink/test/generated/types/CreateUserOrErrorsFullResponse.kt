...
data class CreateUserOrErrorsFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: CreateUserOrErrorsResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "CreateUserOrErrorsFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): CreateUserOrErrorsFullResponse = CreateUserOrErrorsFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { CreateUserOrErrorsResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
