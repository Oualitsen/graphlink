...
data class UpdateUserFullResponse(
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): UpdateUserFullResponse = UpdateUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { UpdateUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
