...
data class GetAllScalarsFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: GetAllScalarsResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "GetAllScalarsFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): GetAllScalarsFullResponse = GetAllScalarsFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetAllScalarsResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
