...
data class UserCreatedFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: UserCreatedResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "UserCreatedFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): UserCreatedFullResponse = UserCreatedFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { UserCreatedResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
