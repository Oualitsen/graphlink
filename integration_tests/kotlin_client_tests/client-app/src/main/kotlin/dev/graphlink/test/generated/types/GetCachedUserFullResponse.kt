...
data class GetCachedUserFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: GetCachedUserResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "GetCachedUserFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): GetCachedUserFullResponse = GetCachedUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetCachedUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
