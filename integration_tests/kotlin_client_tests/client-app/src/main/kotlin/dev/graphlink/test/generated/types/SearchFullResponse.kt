...
data class SearchFullResponse(
   ...
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "SearchFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): SearchFullResponse = SearchFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { SearchResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
