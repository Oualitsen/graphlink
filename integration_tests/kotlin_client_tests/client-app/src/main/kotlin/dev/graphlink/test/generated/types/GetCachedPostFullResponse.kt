...
data class GetCachedPostFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: GetCachedPostResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "GetCachedPostFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): GetCachedPostFullResponse = GetCachedPostFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetCachedPostResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
