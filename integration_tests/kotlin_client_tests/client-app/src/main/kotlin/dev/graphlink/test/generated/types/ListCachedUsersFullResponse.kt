...
data class ListCachedUsersFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: ListCachedUsersResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "ListCachedUsersFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): ListCachedUsersFullResponse = ListCachedUsersFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { ListCachedUsersResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
