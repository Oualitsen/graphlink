...
data class GetPostFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: GetPostResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "GetPostFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): GetPostFullResponse = GetPostFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetPostResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
