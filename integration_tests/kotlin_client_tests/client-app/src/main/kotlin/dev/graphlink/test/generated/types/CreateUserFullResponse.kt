...
data class CreateUserFullResponse(
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): CreateUserFullResponse = CreateUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { CreateUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
