...
data class FindUserFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: FindUserResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "FindUserFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): FindUserFullResponse = FindUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { FindUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
