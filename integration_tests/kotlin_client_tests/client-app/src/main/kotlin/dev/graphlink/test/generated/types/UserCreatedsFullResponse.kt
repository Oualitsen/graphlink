...
data class UserCreatedsFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: UserCreatedsResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "UserCreatedsFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): UserCreatedsFullResponse = UserCreatedsFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { UserCreatedsResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
