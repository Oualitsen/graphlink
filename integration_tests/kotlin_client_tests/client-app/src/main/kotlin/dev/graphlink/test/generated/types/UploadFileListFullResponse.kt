...
data class UploadFileListFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: UploadFileListResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "UploadFileListFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): UploadFileListFullResponse = UploadFileListFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { UploadFileListResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
