...
data class UploadOneFileFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: UploadOneFileResponse? = null,
) : GraphLinkFullResponse {
   fun toJson(): Map<String, Any?> = mapOf(
           "__typename" to "UploadOneFileFullResponse",
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): UploadOneFileFullResponse = UploadOneFileFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { UploadOneFileResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
