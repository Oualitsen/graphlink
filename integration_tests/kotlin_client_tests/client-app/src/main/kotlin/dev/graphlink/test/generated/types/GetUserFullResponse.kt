...
data class GetUserFullResponse(
   ...
   companion object {
      ...
      fun fromJson(map: Map<String, Any?>): GetUserFullResponse = GetUserFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetUserResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
