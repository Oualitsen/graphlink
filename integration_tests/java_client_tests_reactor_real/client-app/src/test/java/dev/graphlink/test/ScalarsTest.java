...
class ScalarsTest {
    ...
    class NonNullableScalarFields {
        ...
        void id_deserializesToString() {
            GetAllScalarsResponse res = client.queries.getAllScalars("scalar-1").block();
    ...
    class NullableScalarFields_Null {
        ...
        void nullableStr_isNull() {
            assertNull(client.queries.getAllScalars("scalar-1").block().getGetAllScalars().getNullableStr());
        }

        @Test
        void nullableInt_isNull() {
            assertNull(client.queries.getAllScalars("scalar-1").block().getGetAllScalars().getNullableInt());
        }

        @Test
        void nullableFloat_isNull() {
            assertNull(client.queries.getAllScalars("scalar-1").block().getGetAllScalars().getNullableFloat());
        }

        @Test
        void nullableBool_isNull() {
            assertNull(client.queries.getAllScalars("scalar-1").block().getGetAllScalars().getNullableBool());
        }

        @Test
        void nullableId_isNull() {
            assertNull(client.queries.getAllScalars("scalar-1").block().getGetAllScalars().getNullableId());
        }
    }
    ...
    class NullableScalarFields_Present {
        ...
        void nullableStr_hasValue() {
            assertEquals("present", client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getNullableStr());
        }

        @Test
        void nullableInt_hasValue() {
            assertEquals(99, client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getNullableInt());
        }

        @Test
        void nullableFloat_hasValue() {
            assertEquals(2.718, client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getNullableFloat(), 0.001);
        }

        @Test
        void nullableBool_isFalse_notNull() {
            Boolean val = client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getNullableBool();
            assertNotNull(val);
            assertFalse(val);
        }
        ...
        void negativeInt_deserializesCorrectly() {
            assertEquals(-1, client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getIntVal());
        }

        @Test
        void negativeFloat_deserializesCorrectly() {
            assertEquals(-0.5, client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getFloatVal(), 0.001);
        }

        @Test
        void boolFalse_isNotTreatedAsNull() {
            Boolean val = client.queries.getAllScalars("scalar-2").block().getGetAllScalars().getBoolVal();
            assertNotNull(val);
            assertFalse(val);
        }
    }
