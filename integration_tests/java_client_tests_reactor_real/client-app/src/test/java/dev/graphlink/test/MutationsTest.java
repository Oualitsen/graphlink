...
class MutationsTest {
    ...
    class CreateUser {
        ...
        void response_returnsCreatedUser() {
            CreateUserResponse res = client.mutations.createUser(kCreateInput).block();
    ...
    class DeleteUser {
        ...
        void response_returnsTrue() {
            DeleteUserResponse res = client.mutations.deleteUser("user-1").block();
    ...
    class TransferPost {
        ...
        void response_returnsPost() {
            TransferPostResponse res = client.mutations.transferPost("post-1", "user-2").block();
    ...
    class ResetAll {
        ...
        @Test
        void response_returnsTrue() {
            ResetAllResponse res = client.mutations.resetAll().block();
