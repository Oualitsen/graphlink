...
public class QueriesTest {
    ...
    class GetAuthor {
        ...
        void returnsAuthorById() {
            var res = client.queries.getAuthor("1", new GetAuthorFieldArgs(10));
        ...
        void returnsNullForUnknownId() {
            var res = client.queries.getAuthor("missing", new GetAuthorFieldArgs(10));
    ...
    class GetAuthorWithoutArticle {
        ...
        void doesNotRequireLimitArgumentWhenArticlesNotProjected() {
            var res = client.queries.getAuthorWithoutArticle("1");
            assertNotNull(res.getGetAuthor());
            assertEquals("1", res.getGetAuthor().getId());
            assertEquals("Ramdane", res.getGetAuthor().getName());
        }
    ...
    class GetArticle {
        ...
        void returnsArticleById() {
            var res = client.queries.getArticle("1", new GetArticleFieldArgs(2));
    ...
    class GetAuthorAndArticle {
        ...
        void resolvesBothRootFieldsWithOwnArgsPlusSharedFragmentArgument() {
            var res = client.queries.getAuthorAndArticle("1", "3", new GetAuthorAndArticleFieldArgs(1));
    ...
    class ListAuthorsAndListArticles {
        ...
        void listAuthorsReturnsAllAuthors() {
            var res = client.queries.listAuthors(new ListAuthorsFieldArgs(10));
        ...
        void listArticlesReturnsAllArticles() {
            var res = client.queries.listArticles(new ListArticlesFieldArgs(2));
