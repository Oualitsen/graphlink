...
data class GetArticleFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: GetArticleResponse? = null,
   ...
   companion object {
      fun fromJson(map: Map<String, Any?>): GetArticleFullResponse = GetArticleFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { GetArticleResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
