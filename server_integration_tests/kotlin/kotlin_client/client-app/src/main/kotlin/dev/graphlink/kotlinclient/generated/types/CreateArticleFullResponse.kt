...
data class CreateArticleFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: CreateArticleResponse? = null,
   ...
   companion object {
      fun fromJson(map: Map<String, Any?>): CreateArticleFullResponse = CreateArticleFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { CreateArticleResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
