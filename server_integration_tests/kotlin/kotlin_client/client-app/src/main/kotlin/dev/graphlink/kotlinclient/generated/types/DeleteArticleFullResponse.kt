...
data class DeleteArticleFullResponse(
    override val errors: List<GraphLinkError>? = null,
    val data: DeleteArticleResponse? = null,
   ...
   companion object {
      fun fromJson(map: Map<String, Any?>): DeleteArticleFullResponse = DeleteArticleFullResponse(
          errors = (map["errors"] as? List<*>)?.map { e0 -> GraphLinkError.fromJson(e0 as Map<String, Any?>) },
          data = (map["data"] as? Map<*, *>)?.let { DeleteArticleResponse.fromJson(it as Map<String, Any?>) },
      )
   }
}
