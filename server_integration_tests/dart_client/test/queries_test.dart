...
void main() {
  ...
  group('getAuthor', () {
    test('returns author by id', () async {
      final res = await client.queries.getAuthor(id: '1', fieldArgs: const GetAuthorFieldArgs(latestArticlesLimit: 10));
    ...
    test('returns null for unknown id', () async {
      final res = await client.queries.getAuthor(id: 'missing', fieldArgs: const GetAuthorFieldArgs(latestArticlesLimit: 10));
  ...
  group('getAuthorAndArticle', () {
    test('resolves both root fields with their own arguments plus a shared fragment argument', () async {
      final res = await client.queries.getAuthorAndArticle(authorId: '1', articleId: '3', fieldArgs: const GetAuthorAndArticleFieldArgs(latestArticlesLimit: 1));
  ...
  group('listAuthors / listArticles', () {
    test('listAuthors returns all authors', () async {
      final res = await client.queries.listAuthors(fieldArgs: const ListAuthorsFieldArgs(latestArticlesLimit: 10));
