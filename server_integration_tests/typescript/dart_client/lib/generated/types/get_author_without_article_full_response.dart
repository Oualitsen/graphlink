...
class GetAuthorWithoutArticleFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final GetAuthorWithoutArticleResponse? data;
   const GetAuthorWithoutArticleFullResponse({this.errors, this.data});
   ...
   static GetAuthorWithoutArticleFullResponse fromJson(Map<String, dynamic> json) {
      return GetAuthorWithoutArticleFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : GetAuthorWithoutArticleResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
