...
class CreateArticleFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final CreateArticleResponse? data;
   const CreateArticleFullResponse({this.errors, this.data});
   ...
   static CreateArticleFullResponse fromJson(Map<String, dynamic> json) {
      return CreateArticleFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : CreateArticleResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
