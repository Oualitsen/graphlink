...
class GetArticleFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final GetArticleResponse? data;
   const GetArticleFullResponse({this.errors, this.data});
   ...
   static GetArticleFullResponse fromJson(Map<String, dynamic> json) {
      return GetArticleFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : GetArticleResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
