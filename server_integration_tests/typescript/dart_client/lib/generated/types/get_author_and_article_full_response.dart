...
class GetAuthorAndArticleFullResponse implements GraphLinkFullResponse {
   ...
   static GetAuthorAndArticleFullResponse fromJson(Map<String, dynamic> json) {
      return GetAuthorAndArticleFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : GetAuthorAndArticleResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
