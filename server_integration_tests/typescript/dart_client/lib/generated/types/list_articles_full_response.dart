...
class ListArticlesFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final ListArticlesResponse? data;
   const ListArticlesFullResponse({this.errors, this.data});
   ...
   static ListArticlesFullResponse fromJson(Map<String, dynamic> json) {
      return ListArticlesFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : ListArticlesResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
