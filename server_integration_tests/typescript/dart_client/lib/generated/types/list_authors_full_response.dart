...
class ListAuthorsFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final ListAuthorsResponse? data;
   const ListAuthorsFullResponse({this.errors, this.data});
   ...
   static ListAuthorsFullResponse fromJson(Map<String, dynamic> json) {
      return ListAuthorsFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : ListAuthorsResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
