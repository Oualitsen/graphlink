...
class ArticleUpdatedFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final ArticleUpdatedResponse? data;
   const ArticleUpdatedFullResponse({this.errors, this.data});
   ...
   static ArticleUpdatedFullResponse fromJson(Map<String, dynamic> json) {
      return ArticleUpdatedFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : ArticleUpdatedResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
