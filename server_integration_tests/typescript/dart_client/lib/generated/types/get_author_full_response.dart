...
class GetAuthorFullResponse implements GraphLinkFullResponse {
   final List<GraphLinkError>? errors;
   final GetAuthorResponse? data;
   const GetAuthorFullResponse({this.errors, this.data});
   ...
   static GetAuthorFullResponse fromJson(Map<String, dynamic> json) {
      return GetAuthorFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : GetAuthorResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
