...
class DeleteArticleFullResponse implements GraphLinkFullResponse {
   ...
   static DeleteArticleFullResponse fromJson(Map<String, dynamic> json) {
      return DeleteArticleFullResponse(
         errors: (json['errors'] as List<dynamic>?)?.map((e0) => GraphLinkError.fromJson(e0 as Map<String, dynamic>)).toList(),
         data: json['data'] == null ? null : DeleteArticleResponse.fromJson(json['data'] as Map<String, dynamic>),
      );
   }
