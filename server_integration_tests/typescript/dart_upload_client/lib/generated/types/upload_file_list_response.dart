...
class UploadFileListResponse {
   final bool uploadFileList;
   UploadFileListResponse({required this.uploadFileList});
   ...
   static UploadFileListResponse fromJson(Map<String, dynamic> json) {
      return UploadFileListResponse(
         uploadFileList: json['uploadFileList'] as bool,
      );
   }
