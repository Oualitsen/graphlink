...
export type GraphLinkAdapter = (payload: string, operationName: string) => Promise<string>;
...
class _ResolverBase {
   ...
   async _glCallAdapter(payload: GraphLinkPayload): Promise<string> {
      return await this.__gl_adapter__!(JSON.stringify(payload), payload.operationName);
   }
