...
public class GraphLinkResolverBase {
   ...
   GraphLinkResolverBase(GraphLinkClientAdapter adapter, Map<String, String> fragmentMap, GraphLinkCacheStore store, GraphLinkJsonEncoder encoder, GraphLinkJsonDecoder decoder) {
      this.__gl_adapter__ = adapter;this.__gl_fragmentMap__ = fragmentMap;
   ...
   protected String glCallAdapter(GraphLinkPayload payload) {
      return __gl_adapter__.execute(__gl_encoder__.encode(payload));
   }
