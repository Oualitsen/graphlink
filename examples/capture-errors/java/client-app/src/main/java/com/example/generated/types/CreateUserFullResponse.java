...
public class CreateUserFullResponse implements GraphLinkFullResponse{
   ...
   public CreateUserFullResponse(List<GraphLinkError> errors, CreateUserResponse data) {
      this.errors = errors;
      this.data = data;
   }
   ...
   public static class Builder {
      ...
      public Builder data(CreateUserResponse data) {
         this.data = data;
         return this;
      }

      public CreateUserFullResponse build() {
         return new CreateUserFullResponse(errors, data);
      }
   }
   ...
   public static CreateUserFullResponse fromJson(Map<String, Object> json) {
      return new CreateUserFullResponse(
      ...
      json.get("data") == null ? null : CreateUserResponse.fromJson((Map<String, Object>)json.get("data"))
      );
   }
